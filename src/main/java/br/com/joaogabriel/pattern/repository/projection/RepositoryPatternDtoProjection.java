package br.com.joaogabriel.pattern.repository.projection;
...
public class RepositoryPatternDtoProjection {
    private UUID id;
     ...
     * */
    public RepositoryPatternDtoProjection(UUID id, String pattern) {
        this.id = id;
